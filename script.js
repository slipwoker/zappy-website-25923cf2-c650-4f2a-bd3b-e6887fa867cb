document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.tagName === 'SELECT' && (value === '' || value === null)) {
  ...
  if (animatedElements.length > 0) {
    ...
    function applyInitialStyles(el) {
      ...
      if (!el.style.transform) {
        ...
        const distance = el.dataset.animateDistance || '30px';
    ...
    if ('IntersectionObserver' in window) {
      ...
      function isElementInViewport(el) {
        ...
        return rect.top <= windowHeight * (1 - ANIMATION_THRESHOLD) && rect.bottom >= 0;
      }

      function checkVisibility() {
        animatedElements.forEach(function (el) {
          if (!el.classList.contains('animated') && isElementInViewport(el)) {
            revealElement(el);
          }
        });
      }
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Lior Design uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '25923cf2-c650-4f2a-bd3b-e6887fa867cb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '25923cf2-c650-4f2a-bd3b-e6887fa867cb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '25923cf2-c650-4f2a-bd3b-e6887fa867cb';
